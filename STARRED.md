...
- [evalstats](https://github.com/ianarawjo/evalstats) - Statistical analysis for LLM evaluations, from model comparisons to inference resilient to LLM judge bias, optimized for small sample sizes. All defaults battle-tested in Monte Carlo simulations.  
