...
- [baker-uv-template](https://github.com/pasunboneleve/baker-uv-template) - Reproducible Python project bootstrap using uv and baker, with testing, linting and type checking preconfigured.  
